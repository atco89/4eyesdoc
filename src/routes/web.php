...
$app->group(null, function () use ($app) {
    ...
    $app->get('/patients/icd-10/{pageId}', 'PatientController:icd10Table')->setName('patient.icd10.table');
    ...
    // -------------------- export to xml --------------------
    $app->group(null, function () use ($app) {
        $app->get('/export/xml/users', 'UserRegisterXMLExport:run')->setName('xml.users');
        $app->get('/export/xml/schedule', 'UserWorkScheduleXMLExport:run')->setName('xml.schedule');
        $app->get('/export/xml/patients', 'PatientRegisterXMLExport:run')->setName('xml.patients');
        $app->get('/export/xml/appointments', 'AppointmentsRegisterXMLExport:run')->setName('xml.appointments');
    })->add('XMLMiddleware');
