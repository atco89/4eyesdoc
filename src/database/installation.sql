...
INSERT INTO `tbl_user` (`name`, `surname`, `group_role_id`, `username`, `password`, `user_color`, `email`, `dial_number_id`, `phone_number`, `created_by`, `updated_by`)
VALUES
  ('The', 'Admin', 1, 'admin', sha1('admin'), '#804000', 'contact@aleksandarrakic.com', 6, '0904606', 1, 1);
...
VALUES
  ...
  ('Kompletan oftalmološki pregled kod univerzitetskog profesora i docenta', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska, pregled prednjeg segmenta oka, pregled očnog dna'),
  ('Pregled prednjeg segmenta oka', 'Određivanje vidne oštrine i dioptrije, pregled na biomikroskopu, stanje očnog sočiva (katarakta i sl.)'),
  ('Prvi pregled prednjeg segmena oka za kontaktna sočiva', 'Određivanje vidne oštrine i dioptrije, pregled na biomikroskopu, stanje očnog sočiva (katarakta i sl.), ispitivanje suznog filma'),
  ('Pregled prednjeg segmenta oka za kontaktna sočiva', 'Određivanje vidne oštrine i dioptrije, pregled na biomikroskopu, stanje očnog sočiva (katarakta i sl.), ispitivanje suznog filma'),
  ...
  ('Određivanje dioptrije, bez drugih oftalmološkog pregleda', 'Određivanje dioptrije, bez drugih oftalmološkog pregleda'),
  ('Oftalmološki pregled u sklopu sistematskog pregleda – uslužno', 'Određivanje vidne oštrine i dioptrije, pregled prednjeg segmenta oka, stanje očnog sočiva, pregled očnog dna, Ishihara, stereo vid, motilitet'),
  ('Ultrawave analajzer – celokupni bezkontaktni pregled prednjeg segmenta oka', 'Merenje očnog pritiska bezkontaktno, merenje debljine rožnjače uz korekcioni faktor za očni pritisak, merenje zakrivljenosti rožnjače, određivanje dioptrije (uslovi dana i noći), dubina prednje očne komore, širina komornog ugla, izgled očnog s...'),
  ('Kompletan oftalmološki pregled uključujući OCT makule ili očnog živca kod univerzitetskog profesora, docent ili kliničkog retinologa', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska, pregled prednjeg segmenta oka, stanje očnog sočiva, pregled očnog dna, optička koherentna tomografija žute mrlje ili očnog živca, Amsler ili Ishihara'),
  ('Kompletan oftalmološki pregled uključujući OCT makule ili očnog živca i foto fundus dokumentaciju očnog dna / univerzitetski profesor, docent, klinički retinolog', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska, pregled prednjeg segmenta oka, pahimetrija, stanje očnog sočiva, pregled očnog dna, autofluorescencija očnog dna, pregled retinalnih nervnih vlakana i krvnih sudova uz pomoć specijaln...'),
  ('Pregled za glaukom / univerzitetski profesor, docent, klinički glaukomatolog', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska, pahimetrija, pregled prednjeg segmenta oka, stanje očnog sočiva, pregled očnog dna, kompjuterizovano vidno polje, pahimetrija, optička koherentna tomografija očnog živca'),
  ('Pregled za glaukom', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska, pahimetrija, pregled prednjeg segmenta oka, stanje očnog sočiva, pregled očnog dna, kompjuterizovano vidno polje, pahimetrija, optička koherentna tomografija očnog živca'),
  ('Osnovni neurooftalmološki pregled sa neurološkim vidnm poljem', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska, pahimetrija, pregled prednjeg segmenta oka, stanje očnog sočiva, pregled očnog dna, pokretljivost očne jabučice, reakcija zenica, test raspoznavanja boja-Ishihara, procena izgleda pap...'),
  ('Osnovni strabološki pregled', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska (gde je moguće), pregled prednjeg segmenta oka, stanje očnog sočiva, pregled očnog dna, pokretljivost očne jabučice, cikloplegija, skrining za strabizam'),
  ('Osnovni strabološki pregled / univerzitetski profesor, docent, klinički strabolog', 'Određivanje vidne oštrine i dioptrije, merenje očnog pritiska (gde je moguće), pregled prednjeg segmenta oka, stanje očnog sočiva, pregled očnog dna, pokretljivost očne jabučice, cikloplegija, skrining za strabizam'),
  ('Pregled za teleskopska pomagala (low vision aid) / univerzitetski professor, docent', 'Određivanje jačine teleskopa, prizmi ili elektronskih pomagala za slabovide, bez širenja zenica, na osnovu indikacije drugog oftalmologa ili zbog lične potrebe pacijenta'),
  ...
  ('Citološki razmaz konjunktive i rožnjače /skreping', 'Uzimanje specijalnog brisa ćelija konjunktive (spojnice) ili rožnjače oka'),
  ('Ispitivanje suznog filma (shirmer, BUT)', 'Merenje količine i kvaliteta suza'),
  ('Instrumentalno vađenje stranog tela na konjunktivi i rožnjači', 'Vađenje stranog tela na spojnici oka ili rožnjači, lokalna anestezija, aplikacija kapi i masti, zavoj'),
  ...
  ('Dnevna kriva očnog pritiska – beskontaktno', 'Pet merenja očnog pritiska u toku jednog dana bez dodirivanja oka i ukapavanja anestetika'),
...
VALUES
  ('Zakazan pregled', 'scheduled-appointment', 1, FALSE, TRUE),
...
VALUES
  ('Specijalistički izveštaj', 'specialist-examination.html.twig'),
